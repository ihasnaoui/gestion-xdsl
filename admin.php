            ...
            <aside>
                <nav class="drilldownMenu">
					...
					<li class="current"><a href="#dashboard.php" title="Dashboard"><img src="images/navicons/81.png" alt=""/><span>Dashboard</span></a></li>
                        ...
                        <li class="hasul"><a href="#tables.html" title="Inventory"><img src="images/navicons/29.png" alt=""/><span>Inventory</span></a>
							 <ul>
							 <li><a href="#inventaire.php" title="Form Sample 1"><img src="images/navicons/20.png" alt="" width="48" height="48"/><span>Inventory Setting</span></a></li>
                        ...
                        <li class="hasul"><a href="#" title="Help"><img src="images/navicons/96.png" alt=""/><span>help</span></a>
                            <ul>
                                <li><a href="#services.php" title="Service profile"><img src="images/navicons/171.png" alt=""/><span>Service profile</span></a></li>
    ...
    <div id="notifications-popover" class="popover">
        ...
        <section>
            <div class="content">
                <nav>
                    <ul>
                        <li class="new"><a><span class="avatar"></span>...</a></li>
    ...
    <div id="settings-popover" class="popover">
        ...
        <section>
            <div class="content">
                <nav>
                    <ul>
                        <li><a href="#projet.php" title="Notifications">Project Settings</a></li>
