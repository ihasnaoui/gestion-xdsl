                ...
                <div class="container_12 clearfix leading">
                    <div class="grid_12">
                        <!-- wizard -->
                        <form action="#" method="POST" class="wizard" novalidate>
                            <nav>
                                <ul class="clearfix">
                            ...
                            <div class="items">
                                ...
                                <section>
                                        ...
                                        <ul class="clearfix">
                                            ...
                                            <li class="double">
                                                ...
                                                <label>
                                                    ...
                                                    <input type="password" class="full" name="password1"  />
                                                </label>
                                            </li>
                                        </ul>
                                    </section>
                                    ...
                                    <footer class="clearfix">
                                        <button type="button" name="test" class="next fr">Proceed &raquo;</button>
                                    </footer>
